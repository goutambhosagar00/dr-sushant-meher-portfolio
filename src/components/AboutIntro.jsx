    ...
    >
      <div className="about-intro-container">
        ...
        <div className="about-intro-image">
          <img src={sirPhoto} alt="Sushant Meher" />
        </div>

        {/* RIGHT CONTENT */}
        <div className="about-intro-content">
          <h1>About  Sushant Meher</h1>

          <p>
            Sushant Meher is an Assistant Professor in the Department of
            ...
            implementation, Meher has established himself as a dedicated
          ...
          <p>
            ...
            applications. Through his research, Meher aims to bridge the
            gap between cutting-edge wireless technology and its practical
            deployment in modern telecommunications infrastructure.
          </p>

          <p>
            Beyond research, Meher is deeply committed to education and
